...
- `config/opencode.json`: backed-up OpenCode global config for `lmstudio/local-coder`.
...
- `config/com.ohmz.opencode.env.plist`: LaunchAgent for persistent GUI env.
...
- `scripts/ensure-lmstudio-models.sh`: downloads/loads chat and embedding models.
