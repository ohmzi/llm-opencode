...
require_profile_vars OPENCODE_CONFIG_DIR OPENCODE_LAUNCH_ENV
...
chmod +x "$DEST/mcp/"*.py "$DEST/ensure-lmstudio-models-linux.sh" "$DEST/check-model-state.sh" "$DEST/validate-profile-sync.sh" "$OPENCODE_LAUNCH_ENV"
